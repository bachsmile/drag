<template>
  <div class="draggable-common">
    ...
    >
      <div class="style" :style="{'width': `${input.w}px`}">
...
export default {
 ...
 watch: {
  ...
  //  setTimeout(()=> {
  //    this.input = {...this.option, ...{w: this.getSizeAuto('slotElm').w}}
  //  }, 0)
    this.randomProperty()
 },
 methods: {
  ...
  onResize(left, top, width, height) {
    ...
    if( this.isAuto.w) {
      //  this.isAuto.w = false
        // this.pickAuto()
      console.log(this.$refs.slotElm.width)
    }
  ...
  setSizeAuto(refs){
    // this.$refs.slotElm.width = 100
    // this.$refs.slotElm.height = 100
  },
  pickAuto(e){
    console.log(this.$refs.slotElm)
    this.input.w = this.isAuto.w ? null : this.getSizeAuto('slotElm').w
    this.input.h = this.isAuto.h ? null : this.getSizeAuto('slotElm').h
    this.option.w = this.isAuto.w ? 'auto': this.getSizeAuto('slotElm').w
    this.option.h = this.isAuto.h ? 'auto': this.getSizeAuto('slotElm').h
  }
 },
}
</script>
